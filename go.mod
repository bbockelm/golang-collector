...
require (
	github.com/PelicanPlatform/classad v0.16.2
	github.com/PelicanPlatform/classad/collections v0.16.2
	github.com/PelicanPlatform/classad/db v0.16.2
	github.com/PelicanPlatform/classad/dbrpc v0.16.2
